...
var RTCMultiConnection = function (roomid, forceOptions) {
    function SocketConnection(connection, connectCallback) {
            ...
            if (message.remoteUserId == connection.userid) {
                if (
                    (connection.peers[message.sender] &&
                        connection.peers[message.sender].extra !=
                    ...
                    var stream =
                        connection.streamEvents[message.message.streamid];
                ...
                if (message.message.allParticipants)
                    return (
                        message.message.allParticipants.indexOf(
                            message.sender
                        ) === -1 &&
                            message.message.allParticipants.push(
                                message.sender
                            ),
                        void message.message.allParticipants.forEach(function (
                            ...
                            mPeer[
                                ...
                                remotePeerSdpConstraints: {
                                    OfferToReceiveAudio: connection.session
                                        .oneway
                                        ? !!connection.session.audio
                                        : connection.sdpConstraints.mandatory
                                              .OfferToReceiveAudio,
                                    OfferToReceiveVideo: connection.session
                                        .oneway
                    ...
                    var userPreferences = {
                        ...
                        dontGetRemoteStream:
                            "undefined" != typeof message.message.isOneWay
                                ...
                                : !!connection.session.oneway ||
                                  "one-way" === connection.direction,
                        dontAttachLocalStream: !!message.message
                            .dontGetRemoteStream,
                ...
                return (
                    ...
                    message.message.userLeft
                        ? (mPeer.onUserLeft(message.sender),
                          void (
                              message.message.autoCloseEntireSession &&
                              connection.leave()
                          ))
                        : void mPeer.addNegotiatedMessage(
                              message.message,
                              message.sender
                          )
                );
        ...
        (parameters += "?userid=" + connection.userid),
            ...
            (parameters +=
                "&socketCustomEvent=" + connection.socketCustomEvent),
            (parameters +=
                "&autoCloseEntireSession=" +
                !!connection.autoCloseEntireSession),
            connection.session.broadcast === !0 &&
    ...
    function MultiPeers(connection) {
        ...
        (connection.peers = {
            ...
            send: function (data, remoteUserId) {
                ...
                if (
                    ("text" === data.type && (data = JSON.stringify(data)),
                    remoteUserId)
                ) {
                    var remoteUser = connection.peers[remoteUserId];
                    if (remoteUser)
                        return remoteUser.channels.length
                            ? void remoteUser.channels.forEach(function (
                                  channel
                              ) {
                                  channel.send(data);
                              })
                ...
                this.getAllParticipants().forEach(function (participant) {
                    return that[participant].channels.length
                        ? void that[participant].channels.forEach(function (
                              channel
                          ) {
                              channel.send(data);
                          })
                ...
                return (
                    userPreferences || (userPreferences = {}),
                    {
                        ...
                        connectionDescription:
                            userPreferences.connectionDescription,
                        userid: remoteUserId,
                        localPeerSdpConstraints:
                            userPreferences.localPeerSdpConstraints,
                        remotePeerSdpConstraints:
                            userPreferences.remotePeerSdpConstraints,
                        ...
                        onDataChannelMessage: function (message) {
                            if (
                                ...
                                return void self.onDataChannelMessage(
                                    message,
                                    remoteUserId
                                );
                            var that = this;
                            return message instanceof ArrayBuffer ||
                                ...
                                : void connection.fbr.addChunk(
                                      ...
                                      function (promptNextChunk) {
                                          connection.peers[
                                              remoteUserId
                                          ].peer.channel.send(promptNextChunk);
                                      }
                                  );
                        },
                        ...
                        onRemoteStream: function (stream) {
                            connection.peers[remoteUserId] &&
                                connection.peers[remoteUserId].streams.push(
                                    stream
                                ),
                        ...
                        onPeerStateChanged: function (states) {
                            self.onPeerStateChanged(states),
                                "new" === states.iceConnectionState &&
                                    self.onNegotiationStarted(
                                        remoteUserId,
                                        states
                                    ),
                                "connected" === states.iceConnectionState &&
                                    self.onNegotiationCompleted(
                                        remoteUserId,
                                        states
                                    ),
                                states.iceConnectionState.search(
                                    /closed|failed/gi
                                ) !== -1 &&
            ...
            (this.createNewPeer = function (remoteUserId, userPreferences) {
                if (
                    ...
                    if (
                        ...
                        !userPreferences.isOneWay &&
                            !userPreferences.isDataOnly)
                    )
                        return (
                    ...
                    connection.peers[remoteUserId] = new PeerInitiator(
                        localConfig
                    );
                }
            }),
            ...
            (this.renegotiatePeer = function (
                ...
                userPreferences || (userPreferences = {}),
                    ...
                    (userPreferences.peerRef =
                        connection.peers[remoteUserId].peer),
                    (userPreferences.channels =
                        connection.peers[remoteUserId].channels);
                var localConfig = this.getLocalConfig(
                    remoteSdp,
                    remoteUserId,
                    userPreferences
                ...
                return peer.getSenders &&
                    ...
                    ? void peer.getSenders().forEach(function (rtpSender) {
                          isVideoTrack &&
                              ...
                              ((connection.peers[
                                  remoteUserId
                              ].peer.lastVideoTrack = rtpSender.track),
                              rtpSender.replaceTrack(track)),
                              isVideoTrack ||
                                  "audio" !== rtpSender.track.kind ||
                                  ((connection.peers[
                                      remoteUserId
                                  ].peer.lastAudioTrack = rtpSender.track),
                                  rtpSender.replaceTrack(track));
                      })
            ...
            (this.addNegotiatedMessage = function (message, remoteUserId) {
                if (message.type && message.sdp)
                    return (
                        "answer" == message.type &&
                            connection.peers[remoteUserId] &&
                            connection.peers[remoteUserId].addRemoteSdp(
                                message
                            ),
                        "offer" == message.type &&
                            (message.renegotiatingPeer
                                ? this.renegotiatePeer(
                                      remoteUserId,
                                      null,
                                      message
                                  )
                                : this.createAnsweringPeer(
                                      message,
                                      remoteUserId
                                  )),
                        void (
                ...
                if (message.candidate)
                    return (
                        connection.peers[remoteUserId] &&
                            connection.peers[remoteUserId].addRemoteCandidate(
                                message
                            ),
                        void (
                            connection.enableLogs &&
                            console.log(
                                "Remote peer's candidate pairs:",
                                message.candidate
                            )
                        )
                    );
        ...
        (this.onDataChannelMessage = function (message, remoteUserId) {
            ...
            (this.getRemoteStreams = function (remoteUserId) {
                return (
                    (remoteUserId =
                        remoteUserId ||
                        connection.peers.getAllParticipants()[0]),
                    connection.peers[remoteUserId]
    ...
    function setHarkEvents(connection, streamEvent) {
        if (
            streamEvent.stream &&
            getTracks(streamEvent.stream, "audio").length
        ) {
                    ...
                    function () {
                        if (
                            ...
                            (streamEndedEvent = "ended"),
                                "oninactive" in stream &&
                                    (streamEndedEvent = "inactive"),
                                StreamsHandler.onSyncNeeded(
                                    stream.streamid,
                                    streamEndedEvent
                                ),
                            ...
                            if (streamEvent)
                                return void connection.onstreamended(
                                    streamEvent
                                );
                            this.parentNode &&
    ...
    function PeerInitiator(config) {
                            ...
                            function () {
                                connection.trickleIce &&
                                    (config.onLocalSdp({
                                        ...
                                        sdp: localSdp.sdp,
                                        remotePeerSdpConstraints:
                                            config.remotePeerSdpConstraints ||
                                            !1,
                                        renegotiatingPeer:
                                            !!config.renegotiatingPeer || !1,
                                        connectionDescription:
        ...
        config.remoteSdp &&
            (this.connectionDescription =
                config.remoteSdp.connectionDescription);
        ...
        if (
            ...
            try {
                var params = {
                    ...
                    iceTransportPolicy:
                        connection.iceTransportPolicy || iceTransports,
                };
                "undefined" != typeof connection.iceCandidatePoolSize &&
                    (params.iceCandidatePoolSize =
                        connection.iceCandidatePoolSize),
        ...
        !peer.getRemoteStreams &&
            ...
            localStreams.forEach(function (localStream) {
                (config.remoteSdp &&
                    ...
                    ((localStream = connection.beforeAddingStream(
                        localStream,
                        self
                    )),
                    localStream &&
                ...
                connection.peers[self.userid] &&
                    ...
                    peer &&
                        ...
                        peer &&
                            ...
                            peer.iceConnectionState.search(
                                /closed|failed/gi
                            ) !== -1 &&
                            self.streams instanceof Array &&
                            self.streams.forEach(function (stream) {
                                var streamEvent = connection.streamEvents[
                                    stream.id
                                ] || {
                                    streamid: stream.id,
                                    stream: stream,
        ...
        (peer.ontrack = function (event) {
            if (event && "track" === event.type) {
                ...
                streamToShare
                    ...
                    : ((event.stream.isVideo = !!getTracks(
                          event.stream,
                          "video"
                      ).length),
    ...
    function getUserMediaHandler(options) {
        function streaming(stream, returnBack) {
            ...
            "oninactive" in stream && (streamEndedEvent = "inactive"),
                stream.addEventListener(
                    ...
                    function () {
                        delete currentUserMediaRequest.streams[idInstance],
                            ...
                            currentUserMediaRequest.queueRequests.indexOf(
                                options
                            ) &&
                ...
                currentUserMediaRequest.queueRequests.length &&
                    getUserMediaHandler(
                        currentUserMediaRequest.queueRequests.shift()
                    ),
        ...
        if (currentUserMediaRequest.streams[idInstance])
            ...
            var isBlackBerry = !!/BB10|BlackBerry/i.test(
                navigator.userAgent || ""
            );
            if (
                isBlackBerry ||
    ...
    !(function (that) {
        ...
        (function () {
                ...
                switch (
                    ...
                    case "Mac OS X":
                        /Mac OS X (10[\.\_\d]+)/.test(nAgt) &&
                            (osVersion = /Mac OS X (10[\.\_\d]+)/.exec(
                                nAgt
                            )[1]);
                        break;
                    case "Android":
            ...
            "undefined" == typeof MediaStream &&
                ...
                "function" == typeof MediaStream
                    ? (DetectRTC.MediaStream = Object.keys(
        ...
        (window.attachEventListener = function (
            video,
            type,
            listener,
            useCapture
    ...
    var RTCSessionDescription =
        ...
        CodecsHandler = (function () {
            ...
            function preferCodecHelper(sdp, codec, info, ignore) {
                ...
                var newLine =
                        info.videoCodecNumbersOriginal.split("SAVPF")[0] +
                        "SAVPF ",
                    newOrder = [preferCodecNumber];
                return (
                    ignore && (newOrder = []),
                    info.videoCodecNumbers.forEach(function (codecNumber) {
                        codecNumber !== preferCodecNumber &&
            ...
            function findLineInRange(
                ...
                for (
                    var realEndLine =
                            endLine !== -1 ? endLine : sdpLines.length,
                        i = startLine;
                    i < realEndLine;
                    ++i
                )
            ...
            function setVideoBitrates(sdp, params) {
                ...
                if (null !== rtxFmtpLineIndex) {
                    ...
                    (appendrtxNext +=
                        ...
                        (sdpLines[rtxFmtpLineIndex] = sdpLines[
                            rtxFmtpLineIndex
                        ].concat(appendrtxNext)),
                        (sdp = sdpLines.join("\r\n"));
                }
                return sdp;
            }
            function setOpusAttributes(sdp, params) {
                ...
                if (
                    (opusIndex &&
                        (opusPayload = getCodecPayloadType(
                            sdpLines[opusIndex]
                        )),
                    !opusPayload)
                )
                ...
                return (
                    ...
                    (sdpLines[opusFmtpLineIndex] = sdpLines[
                        opusFmtpLineIndex
                    ].concat(appendOpusNext)),
                    (sdp = sdpLines.join("\r\n"))
                );
            }
            function forceStereoAudio(sdp) {
                ...
                return null === fmtpLineIndex
                    ? sdp
                    : ((sdpLines[fmtpLineIndex] = sdpLines[
                          fmtpLineIndex
                      ].concat("; stereo=1; sprop-stereo=1")),
                      (sdp = sdpLines.join("\r\n")));
            }
            return {
                removeVPX: removeVPX,
                ...
                setApplicationSpecificBandwidth: function (
                    sdp,
                    bandwidth,
                    isScreen
                ) {
        ...
        remove: function (idInstance) {
            ...
            if (stream) {
                ...
                this.queueRequests.indexOf(options) &&
                    (delete this.queueRequests[
                        this.queueRequests.indexOf(options)
                    ],
                    (this.queueRequests = removeNullEntries(
                        this.queueRequests
                    ))),
                    ...
                    (stream.mute = function (type, isSyncAction) {
                        (type = handleType(type)),
                            ...
                            ("undefined" != typeof type && "audio" != type) ||
                                getTracks(stream, "audio").forEach(function (
                                    track
                                ) {
                                    (track.enabled = !1),
                            ...
                            ("undefined" != typeof type && "video" != type) ||
                                getTracks(stream, "video").forEach(function (
                                    track
                                ) {
                                    track.enabled = !1;
                                }),
                            ("undefined" != typeof syncAction &&
                                1 != syncAction) ||
                                StreamsHandler.onSyncNeeded(
                                    stream.streamid,
                                    "mute",
                        ...
                        (stream.unmute = function (type, isSyncAction) {
                            (type = handleType(type)),
                                ...
                                ("undefined" != typeof type &&
                                    "audio" != type) ||
                                    getTracks(stream, "audio").forEach(
                                        function (track) {
                                            (track.enabled = !0),
                                                (connection.streamEvents[
                                                    stream.streamid
                                ...
                                ("undefined" != typeof type &&
                                    "video" != type) ||
                                    (getTracks(stream, "video").forEach(
                                        function (track) {
                                            track.enabled = !0;
                                        }
                                    ),
            ...
            function handle(connection) {
                function updateLabel(progress, label) {
                    if (progress.position !== -1) {
                        var position =
                            +progress.position.toFixed(2).split(".")[1] || 100;
                ...
                (connection.onFileStart = function (file) {
                    ...
                    return (
                        ...
                        file.remoteUserId &&
                            (div.innerHTML +=
                                " (Sharing with:" + file.remoteUserId + ")"),
                        ...
                        file.remoteUserId
                            ...
                            : ((progressHelper[file.uuid] = {
                              ...
                              void (progressHelper[file.uuid].progress.max =
                                  file.maxChunks))
                    );
                }),
        ...
        TranslationHandler = (function () {
            function handle(connection) {
                (connection.autoTranslateText = !1),
                    ...
                    (connection.googKey =
                        "AIzaSyCgB5hmFY74WYB-EoWkhr9cAGr6TiTHrEE"),
    ...
    !(function (connection) {
        ...
        function getStreamInfoForAdmin() {
            try {
                return connection.streamEvents
                    .selectAll("local")
                    .map(function (event) {
                        return {
        ...
        (mPeer.onGettingLocalMedia = function (stream, callback) {
            ...
            (mPeer.onNegotiationNeeded = function (
                message,
                remoteUserId,
                callback
            ) {
            ...
            (connection.deletePeer = function (remoteUserId) {
                if (remoteUserId && connection.peers[remoteUserId]) {
                    ...
                    if (
                        ...
                        connection.peers[remoteUserId].streams.forEach(
                            function (stream) {
                                stream.stop();
                            }
                        );
            ...
            (connection.join = function (remoteUserId, options) {
                ...
                "function" == typeof options &&
                    ...
                    "undefined" != typeof options.remotePeerSdpConstraints &&
                        (remotePeerSdpConstraints =
                            options.remotePeerSdpConstraints),
                          ...
                          : ((connection.bandwidth.video ||
                            ...
                            connection.bandwidth.audio &&
                                (sdp = CodecsHandler.setOpusAttributes(sdp, {
                                    maxaveragebitrate:
                                        8 * connection.bandwidth.audio * 1024,
                                    maxplaybackrate:
                                        8 * connection.bandwidth.audio * 1024,
                                    stereo: 1,
                                    maxptime: 3,
                ...
                video: {
                    ...
                    optional: connection.bandwidth.video
                        ? [
                              {
                                  bandwidth:
                                      8 * connection.bandwidth.video * 1024 ||
                                      1048576,
                              },
                              { facingMode: "user" },
                          ]
                ...
                DetectRTC.load(function () {
                    ...
                    if (
                        ...
                        if ("Firefox" === DetectRTC.browser.name)
                            return void (connection.mediaConstraints.audio !==
                            !0
                    ...
                    if (lastVideoDevice) {
                        if ("Firefox" === DetectRTC.browser.name)
                            return void (connection.mediaConstraints.video !==
                            !0
                ...
                session || (session = connection.session),
                    ...
                    getUserMediaHandler({
                            ...
                            videoConstraints &&
                                ...
                                videoConstraints.mozMediaSource
                                    ...
                                    : videoConstraints.mandatory &&
                                      ...
                                      (stream.isScreen = !0)),
                                stream.isScreen ||
                                    ((stream.isVideo = !!getTracks(
                                        stream,
                                        "video"
                                    ).length),
                                    (stream.isAudio =
                                        !stream.isVideo &&
                                        getTracks(stream, "audio").length)),
                        ...
                        localMediaConstraints: localMediaConstraints || {
                            audio:
                                !!session.audio && localMediaConstraints.audio,
                            video:
                                !!session.video && localMediaConstraints.video,
                        },
                    });
            }),
            (connection.applyConstraints = function (
                mediaConstraints,
                streamid
            ) {
                if (
                    ...
                    "oninactive" in stream && (streamEndedEvent = "inactive"),
                        stream.addEventListener(
                            ...
                            function () {
                                if (
                                    (stream.idInstance &&
                                        currentUserMediaRequest.remove(
                                            stream.idInstance
                                        ),
                                    !isRemote)
                                ) {
                                ...
                                if (
                                    ...
                                    isRemote &&
                                        connection.peers[streamEvent.userid])
                                ) {
                                    var peer =
                                            connection.peers[streamEvent.userid]
                                                .peer,
                                ...
                                (streamEvent.userid === connection.userid &&
                                    ...
                                    connection.onstreamended(streamEvent),
                                    delete connection.streamEvents[
                                        stream.streamid
                                    ]);
                            },
                            !1
            ...
            "undefined" != typeof StreamsHandler &&
                (StreamsHandler.onSyncNeeded = function (
                    streamid,
                    action,
                    type
                ) {
            ...
            (connection.getSocket = function (callback) {
                return (
                    !callback &&
                        connection.enableLogs &&
                        console.warn(
                            "getSocket.callback paramter is required."
                        ),
                    (callback = callback || function () {}),
                    connection.socket
        ...
        if (
            ((connection.streamEvents = {
                ...
                selectAll: function (options) {
                    ...
                    var streams = [];
                    return (
                        Object.keys(connection.streamEvents).forEach(function (
                            key
                        ) {
                            ...
                            if (skipStreams.indexOf(key) === -1) {
                                ...
                                options.local &&
                                    ...
                                    options.isScreen &&
                                        ...
                                        (ignore = !1),
                                    options.isVideo &&
                                        event.stream.isVideo &&
                                        (ignore = !1),
                                    options.isAudio &&
                                        event.stream.isAudio &&
                                        (ignore = !1),
                                    options.userid &&
            ...
            (connection.socketCustomEvent =
                "RTCMultiConnection-Custom-Message"),
            ...
            (connection.setCustomSocketHandler = function (
                customSocketHandler
            ) {
            ...
            (connection.onReadyForOffer = function (
                remoteUserId,
                userPreferences
            ) {
            ...
            (connection.modifyScreenConstraints = function (
                screen_constraints
            ) {
            ...
            if (
                ...
                var newArray = [];
                connection.mediaConstraints.audio.optional.forEach(function (
                    opt
                ) {
            ...
            if (
                ...
                var newArray = [];
                connection.mediaConstraints.video.optional.forEach(function (
                    opt
                ) {
                    "undefined" == typeof opt.bandwidth && newArray.push(opt);
                }),
