...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{route('teacher.insert')}}" method="post" enctype="multipart/form-data" class="card-body">
                    {{csrf_field()}}
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="teacher_experience" class="summernote-simple">{{old('teacher_experience')}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label">Tentang Guru</label>
                                <textarea name="teacher_about" class="summernote-simple">{{old('teacher_about')}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label">Spekualifikasi Guru</label>
                                <textarea name="qualification" class="summernote-simple">{{old('qualification')}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
