...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{route('document.create','update')}}" method="post" enctype="multipart/form-data" class="card-body">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{$data['ini']->title}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control selectric" name="tanda_tangan_id">
                                    ...
                                    <option value="{{$tanda->id}}" <?= $tanda->id == $data['ini']->tanda_tangan_id ? 'selected' : null; ?>>{{$tanda->employee->first_name}} {{$tanda->employee->middle_name}} {{$tanda->employee->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control selectric" name="document_category_id">
                                    ...
                                    <option value="{{$cat->id}}" <?= $cat->id == $data['ini']->document_category_id ? 'selected' : null; ?>>{{$cat->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control selectric" name="template_document_id">
                                    ...
                                    <option value="{{$template->id}}" <?= $template->id == $data['ini']->template_document_id ? 'selected' : null; ?>>{{$template->template_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="summernote">{{$data['ini']->description}}</textarea>
                            </div>
                        </div>
