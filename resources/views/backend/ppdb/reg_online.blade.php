...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form class="row" action="{{route('admin.ppdb.online')}}" method="GET">
                    ...
                    <table class="table table-striped table-hover" id="tablePenjualan" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="badge bg-primary text-white" href="{{route('user.ppdb.detail',encrypt($reg->pendaftar->id))}}">
                                        {{$reg->pendaftar->first_name}} {{$reg->pendaftar->middle_name}} {{$reg->pendaftar->last_name}}
                                    </a>
                                </td>
