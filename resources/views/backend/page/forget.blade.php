...
<body>
    ...
    <main class="login-body" data-vide-bg="{{my_asset('website/theme/assets/img/login-bg.mp4')}}">
        <!-- Login Admin -->
        <form class="form-default" action="{{route('send')}}" method="POST">

            <div class="login-form">
                <!-- logo-login -->
                <div class="logo-login">
                    <a href="{{route('login')}}"><img src="{{my_asset('website/theme/assets/img/logo/loder.png')}}" alt=""></a>
                </div>
                ...
                <!-- Forget Password -->
                <a href="{{route('login')}}" class="forget">Kembali Login</a>
            </div>
        </form>
        <!-- /end login form -->
    </main>
