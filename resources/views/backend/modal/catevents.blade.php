<div class="modal fade" id="add" tabindex="-1" aria-labelledby="add-categori" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{route('cms.insert',['catEvenet'])}}" method="post" enctype="multipart/form-data" class="modal-content">
            {{csrf_field()}}
...
<div class="modal fade" id="update{{$update->id}}" tabindex="-1" aria-labelledby="update-catnews" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{route('cms.insert',['updateCatEvent'])}}" method="post" enctype="multipart/form-data" class="modal-content">
            {{csrf_field()}}
            <div class="modal-header">
