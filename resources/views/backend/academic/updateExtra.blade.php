...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{route('edit.extra')}}" method="post" enctype="multipart/form-data" class="card-body">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <div class="form-group">
                                <label class="label-control">Nama Extrakulikuler</label>
                                <input type="text" name="extra_name" value="{{$update->extra_name}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="extra_note" class="summernote-simple">{{$update->extra_note}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <button class="btn btn-primary">Update Extrakulikuler</button>
                        </div>
                    </div>
                </form>
            </div>
