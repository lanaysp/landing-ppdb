...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{route('admin.announcement_update')}}" method="post" enctype="multipart/form-data" class="card-body">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="announcement_title" value="{{$data->announcement_title}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                <label class="label-control">Tanggal Buat</label>
                                <input type="text" value="{{$data->created_at}}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="summernote-simple">{{$data->description}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
